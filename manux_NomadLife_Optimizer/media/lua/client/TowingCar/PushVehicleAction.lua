...
function TAPushVehicle:perform()
    ...
    local forceVector = self.vehicle:getWorldPos(fx, 0, fz, tempVector1):add(-self.vehicle:getX(), -self.vehicle:getY(), -self.vehicle:getZ())
    local pushPoint = self.vehicle:getWorldPos(x, 0, z, tempVector2):add(-self.vehicle:getX(), -self.vehicle:getY(), -self.vehicle:getZ())
